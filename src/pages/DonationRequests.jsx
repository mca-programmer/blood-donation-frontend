...
const DonationRequests = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-red-500 to-pink-600 text-white py-20">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden">
          ...
          >
            <path
              fill="#f3f4f6"
              d="M0,32L80,32C160,32,320,32,480,32C640,32,800,32,960,26.7C1120,21,1280,11,1360,5.3L1440,0L1440,48L0,48Z"
            />
          </svg>
        </div>
      </section>
      ...
      {/* Requests Section */}
      <section className="container mx-auto px-4 py-14 flex-1">
        {loading ? (
          <div className="py-24">
            <Loading text="Loading donation requests..." />
          </div>
        ) : requests.length ? (
          <>
